...
class EleveController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $eleves = $em->getRepository('EcoleBundle:Eleve')->findAll();
    ...
    {
        $eleve = new Eleve();
        $form = $this->createForm('EcoleBundle\Form\EleveType', $eleve);
    ...
    {
        $deleteForm = $this->createDeleteForm($eleve);
        $editForm = $this->createForm('EcoleBundle\Form\EleveType', $eleve);
