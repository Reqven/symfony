...
$a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/EcoleBundle/Resources/config/doctrine') => 'EcoleBundle\\Entity'));
...
$c->setEntityNamespaces(array('EcoleBundle' => 'EcoleBundle\\Entity'));
